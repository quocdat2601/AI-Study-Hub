...
export const UPLOAD_DOC_ACCEPT_ATTR =
  ".pdf,.docx,.txt,.png,.jpg,.jpeg,.tif,.tiff,.bmp,application/pdf,application/vnd.openxmlformats-officedocument.wordprocessingml.document,text/plain,image/png,image/jpeg,image/tiff,image/bmp";
...
export function validateUploadDocFile(file) {
  if (!UPLOAD_DOC_ACCEPTED_TYPES.includes(file.type)) {
    return "Only PDF, DOCX, TXT, PNG, JPEG, TIFF, and BMP files are accepted.";
  }
