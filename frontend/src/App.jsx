...
import WorkspaceRagPage from "./pages/WorkspaceRagPage.jsx";
...
function AppRoutes() {
  ...
  const dashboardShellRoutes = ["/dashboard", "/account", "/documents", "/library", "/workspace", "/workspace-rag"];
  ...
  return (
    <>
      ...
      <Routes>
        ...
        />
        <Route path="/ai-workspace" element={<Navigate replace to="/workspace" />} />
        <Route
          path="/admin"
          element={
            <AdminRoute>
