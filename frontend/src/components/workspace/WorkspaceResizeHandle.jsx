...
export default function WorkspaceResizeHandle({ onMouseDown, label }) {
  return (
    <div
      aria-label={label}
      className="no-caret group relative z-20 flex w-1.5 shrink-0 cursor-col-resize items-center justify-center bg-slate-200/80 transition hover:bg-indigo-400/70"
