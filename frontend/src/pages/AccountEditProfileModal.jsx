...
export default function AccountEditProfileModal({ initialValues, onClose, onSave }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4 dark:bg-black/60">
      ...
      >
        <h2 className="m-0 text-lg font-bold text-slate-900 dark:text-slate-100">{t("account.editProfile")}</h2>
        <p className="m-0 mt-1 text-sm text-slate-500 dark:text-slate-400">{t("account.editProfileDesc")}</p>
